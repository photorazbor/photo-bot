...
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")  # Старый ключ CheapAI — НЕ УДАЛЯЕМ!
KODIK_API_KEY = "sk-kr_live_YI_2mRhRq88Cz94KGDT8u3GsjZCd8z72"  # НОВЫЙ КЛЮЧ
KODIK_BASE_URL = "https://api.kodikrouter.ru/v1"  # НОВЫЙ URL
