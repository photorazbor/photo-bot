...
async def handle_reference_photo(message: Message, user_id: int, image_bytes: bytes) -> bool:
    ...
    if step == "user_photo":
        ...
        prompt = (
            "Два изображения: ПЕРВОЕ — референс (сцена, поза, стиль), "
            "ВТОРОЕ — фото человека (лицо). "
            "Создай ОДНО изображение — как будто человек со ВТОРОГО фото "
            "реально снялся в этой фотосессии."
            "\n\n"
            "ГЛАВНОЕ — ЦЕЛЬНОСТЬ: "
            "Изображение должно выглядеть как ОДНА настоящая фотография, "
            "а НЕ коллаж или аппликация из двух фото. "
            "Все части тела, лицо, одежда, фон — единое целое, "
            "связанное анатомически, светом и тонированием. "
            "Никаких «отрезанных» или наложенных частей."
            "\n\n"
            "ТЕЛО, ПОЗА, РУКИ, ОДЕЖДА — ИЗ СЦЕНЫ РЕФЕРЕНСА: "
            "Положение корпуса, рук, ног — точно как на референсе. "
            "Одежда, аксессуары, предметы в руках — как на референсе. "
            "НЕ бери руки, позу, тело или одежду со ВТОРОГО фото. "
            "Со ВТОРОГО — ТОЛЬКО лицо."
            "\n\n"
            "ЛИЦО — ТОЛЬКО СО ВТОРОГО: форма лица, брови, глаза "
            "(цвет и разрез), нос, губы, веснушки (или их отсутствие), "
            "родинки, причёска, цвет волос, пол, возраст, тон кожи. "
            "НЕ копируй брови, глаза, нос, губы, веснушки, причёску "
            "с ПЕРВОГО. НЕ добавляй веснушки, если их нет на ВТОРОМ. "
            "НЕ старь и НЕ молоди."
            "\n\n"
            "ИНТЕГРАЦИЯ ЛИЦА В СЦЕНУ: "
            "Лицо освещено светом референса — как падал бы свет "
            "на любого человека в этой сцене. "
            "Тени от шляпы, руки, волос падают на лицо естественно. "
            "Цвет кожи подстраивается под тонирование кадра. "
            "Никаких резких границ между лицом, шеей и телом. "
            "Голова анатомически соединена с шеей и плечами. "
            "Лицо — ЧАСТЬ сцены, а не наложенный портрет."
            "\n\n"
            "СВЕТ И ТЕНИ — точно с референса: "
            "направление источника, жёсткость, цвет, направление теней. "
            "Если на референсе шляпа — тень от шляпы падает на лицо. "
            "Единый источник света во всём кадре."
        )
