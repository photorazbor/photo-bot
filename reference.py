...
async def handle_reference_photo(message: Message, user_id: int, image_bytes: bytes) -> bool:
    ...
    if step == "user_photo":
        ...
        prompt = (
            "Два изображения: ПЕРВОЕ — референс (образец сцены), "
            "ВТОРОЕ — фото человека (лицо). "
            "ЗАДАЧА: создать НОВОЕ изображение, где человек — "
            "с лицом со ВТОРОГО фото — находится в сцене ПЕРВОГО."
            "\n\n"
            "ВАЖНО — ГЕНЕРИРУЙ ЧЕЛОВЕКА ЗАНОВО, А НЕ ВСТАВЛЯЙ ЕГО: "
            "Не накладывай лицо на референс. "
            "Не копируй готовое тело с референса. "
            "Создай НОВОГО человека с нуля: "
            "тело, руки, ноги, поза, одежда — сгенерируй заново, "
            "но так, чтобы поза, одежда и положение тела "
            "ПОЛНОСТЬЮ повторяли референс. "
            "Как будто этот человек со ВТОРОГО фото "
            "сам встал в эту позу и снялся в этой фотосессии."
            "\n\n"
            "ЧТО ПОВТОРЯЕМ С РЕФЕРЕНСА: "
            "позу, положение корпуса, рук, ног, "
            "ракурс камеры, кадрирование, "
            "одежду, аксессуары, предметы в руках, "
            "фон, свет, тени, тонирование, атмосферу, "
            "цветовую гамму, стиль съёмки. "
            "Всё тело — единое целое, анатомически правильное."
            "\n\n"
            ...
            "\n\n"
            "ЕДИНСТВО: "
            "Лицо, шея, руки, тело — единое целое, одно освещение, "
            "один тон кожи, одна цветовая гамма. "
            ...
            "Никаких резких границ между лицом и телом. "
            "Результат — как ОДНА настоящая фотография, а не коллаж."
        )
