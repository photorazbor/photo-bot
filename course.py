...
DAYS = {
    ...
    8: {
        ...
        "theory": (
            "Размытый фон выделяет главный объект и делает кадр профессиональным. На телефоне это «портретный режим» или «размытие фона». Работает не только с людьми: цветы, еда, детали — всё выглядит иначе с мягким фоном.\n\n"
            "📱 Как включить: режим «Портрет» в камере, или подойти близко к объекту и сфокусироваться — фон размоется сам. Чем ближе объект и дальше фон — тем сильнее эффект.\n\n"
            "🎯 Все предыдущие приёмы с тобой. Теперь добавь фокус — выдели главное, убери лишнее."
        ),
        "task": "Сними объект с размытым фоном. Используй портретный режим или подойди близко. Главный объект должен быть резким, фон — мягким.",
