...
DAYS = {
    ...
    9: {
        "title": "Глубина кадра",
        "theory": (
            "Профессиональный пейзаж строится из трёх планов. Передний (близко к камере) — приглашает войти. Средний — главный объект. Задний — фон, атмосфера. Три плана делают кадр глубоким и живым.\n\n"
