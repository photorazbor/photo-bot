...
DAYS = {
    ...
    7: {
        ...
        "theory": (
            "Размытый фон выделяет главный объект и делает кадр профессиональным. На телефоне этого можно добиться двумя способами.\n\n"
            "📱 <b>Способ 1 — Портретный режим:</b> встроенный режим «Портрет» или «Размытие фона». Телефон сам определяет объект и размывает всё остальное. Работает с людьми, цветами, едой, деталями.\n\n"
            "🔍 <b>Способ 2 — Оптический зум:</b> включи зум 2x или 3x и подойди ближе к объекту. Оптический зум сжимает перспективу и усиливает размытие фона — объект остаётся резким, а фон уходит в мягкое размытие. Это работает даже без портретного режима. Чем сильнее зум и чем дальше фон — тем заметнее эффект.\n\n"
