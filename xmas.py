...
XMAS_STYLES = {
    ...
    "soviet_fairy": {
        ...
        "prompt": (
            "СТИЛИЗАЦИЯ: советская новогодняя открытка 1960–70-х годов. "
            "ЭТО ЖИВОПИСНАЯ ИЛЛЮСТРАЦИЯ, А НЕ ФОТОГРАФИЯ. "
            "Стиль акварели или гуаши, мягкие мазки, текстура старой бумаги, "
            "лёгкие потёртости по краям — как у винтажной открытки. "
            "\n\n"
            "ПАЛИТРА: тёплые винтажные тона — приглушённые красные, зелёные, "
            "золотые, кремовые, голубые. Цвета слегка выцветшие, как у открытки 60-х. "
            "\n\n"
            "ЛЮДИ: нарисованные персонажи в стиле советских открыток. "
            "Лица узнаваемые с исходного фото, но в живописной стилизации. "
            "Одежда — по выбранному образу, но в советском стиле: "
            "шубы, тулупы, валенки, шапки-ушанки, вязаные свитера, "
            "пуховые платки, варежки, меховые воротники. "
            "\n\n"
            "ЗВЕРИ-ПЕРСОНАЖИ: добавь вокруг людей советских сказочных зверей — "
            "зайцев, белок, медвежат, снегирей, снеговиков. "
            "Они нарисованы в том же живописном стиле, добрые, с улыбками, "
            "могут держать подарки, музыкальные инструменты, "
            "ёлочные игрушки, мандарины, лыжи, санки. "
            "Звери — часть композиции, а не фон. "
            "\n\n"
            "ДЕКОРАТИВНЫЕ ЭЛЕМЕНТЫ: снежинки, звёзды, месяц, "
            "ёлочные игрушки в винтажном стиле (шары, шишки, ракеты, сосульки), "
            "ёлки в снегу, гирлянды, сугробы. "
            "\n\n"
            "ТЕКСТ НА ОТКРЫТКЕ: крупный рукописный текст «С Новым годом!» "
            "в винтажном стиле. Размести вверху или внизу, красивым курсивом. "
            "Цвет — красный или тёмно-синий. Без других надписей. "
            "\n\n"
            "КОМПОЗИЦИЯ: как у настоящей советской открытки — "
            "люди в центре, звери вокруг, ёлка, зимний лес или поляна. "
            "Рамка с лёгкими потёртостями по краям. "
            "\n\n"
            "НЕ добавляй: фотореализм, современные элементы, "
            "пластиковые лица, реалистичные тени, эффект камеры. "
            "Только живописная рисованная иллюстрация."
        ),
    },
    "soviet_cartoon": {
