...
def _build_prompt(state: dict) -> str | None:
    ...
    if state.get("style") == "soviet_fairy" and state.get("chorovod"):
        chorovod_lock = (
            ...
            "\n\n"
            "КТО В КРУГУ — ЖЁСТКОЕ ПРАВИЛО: "
            "В хороводе ТОЛЬКО: "
            "1) люди с исходного фото (ровно столько, сколько на фото), "
            "2) Дед Мороз, "
            "3) Снегурочка, "
            "4) советские сказочные звери — зайцы, белки, медвежата, снегири, снеговики. "
            "НЕ добавляй других людей — ни детей, ни взрослых, ни прохожих. "
            "Если круг кажется неполным — добавь БОЛЬШЕ ЗВЕРЕЙ, а не людей. "
            "Люди в хороводе — ТОЛЬКО с исходного фото. "
            "Дед Мороз и Снегурочка — единственные новые люди, "
            "но они сказочные персонажи, а не реальные люди. "
            "\n\n"
