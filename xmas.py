...
def _build_prompt(state: dict) -> str | None:
    ...
    atmosphere_lock = (
        ...
        "Мягкий тёплый кинематографичный свет, гирлянды с тёплыми огоньками, золотые блики, боке от огней. "
        "Винтажная цветокоррекция — приглушённые тёплые тона, лёгкая плёночная зернистость, мягкие тени, лёгкое свечение (glow). "
        "Стиль как у старой плёночной новогодней открытки или кадра из рождественского кино. "
        ...
        "Фото должно вызывать ощущение волшебства, уюта и ностальгии по детству. "
    )
