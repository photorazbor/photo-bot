...
XMAS_OUTFITS = {
    ...
    "sweaters": {
        ...
        "prompt": "в тёплых вязаных свитерах новогодних цветов (красный, зелёный, белый), свободный крой. Допустимы вязаные шапки и варежки, если они не портят сходство лиц",
    },
    "coats": {
    ...
    "evening": {
        ...
        "prompt": "в элегантных вечерних нарядах — платья и костюмы, тёплые накидки, изысканно и торжественно, но по погоде",
    },
    "fur": {
        "name": "Шуба",
        "short": "🧥 Шуба",
        "preview": f"{BASE}/xmas/outfits/fur.jpg",
        "prompt": "в элегантной зимней шубе, меховой воротник, тёплая шапка, выглядит роскошно и по-зимнему",
    },
}
