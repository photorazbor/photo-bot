...
WEDDING_STYLES = {
    ...
    "minimal": {
        ...
        "short": "⬜ Минимализм",
        "prompt": (
            "СТИЛЬ: современный fashion-минимализм, как в дорогих свадебных журналах "
            "и Pinterest-бордах 2024–2025. "
            "Эстетика: чистота, воздух, элегантность, современность. "
            "Палитра: белый, молочный, тёплый беж, мягкий песочный, "
            "тонкий акцент — тёплое золото или приглушённая олива. "
            "НЕ чёрный, НЕ графичный, НЕ плакатный. "
            "Декор: одна тонкая линия, веточка, сухоцвет, каллиграфический штрих. "
            "Много пустого пространства. Мягкий свет. "
            "Люди — лёгкая современная иллюстрация, мягкие линии, "
            "без чёрных контуров, без плоских пятен, "
            "деликатная живопись в пастельных тонах. "
            "НЕ советский плакат, НЕ ретро, НЕ карикатура. "
            "Стиль как у современных модных иллюстраторов."
        ),
    },
    "artdeco": {
        "name": "✨ Арт-деко",
        "short": "✨ Арт-деко",
        "prompt": (
            "СТИЛЬ: современный гламурный арт-деко — как в дорогих отельных "
            "свадьбах и ювелирных брендах 2025. "
            "НЕ старый плакат 1920-х. СОВРЕМЕННАЯ эстетика гламура. "
            "Палитра: глубокий тёмный фон (изумруд, тёмно-синий, чёрный), "
            "тёплое золото, шампань, деликатный бордо. "
            "Декор: тонкие геометрические линии, лучи из центра, "
            "веера, деликатные золотые рамочки, лёгкое свечение. "
            "БЕЗ тяжёлых орнаментов и мозаики. "
            "БЕЗ массивных геометрических узоров. "
            "Много элегантного воздуха, а не плотный узор. "
            "Свет: мягкий тёплый, как в ювелирном бутике. "
            "Люди — стилизованная живопись, элегантные, современные, "
            "узнаваемые, гламурные, но без карикатуры. "
            "НЕ ретро-плакат, НЕ старое кино, НЕ Гэтсби. "
            "Стиль как у современных luxury-брендов."
        ),
    },
    "vintage": {
        "name": "📜 Винтаж",
