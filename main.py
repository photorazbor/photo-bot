...
async def do_generation(user_id: int, chat_id: int, gen_type: str):
    ...
    try:
        ...
        prompt = (
            ...
            f"Если есть фрейминг (ветки, арки, окна) — сохрани его. Если веток слишком много — НЕ вырезай их, а добавь между ними воздух и просветы, сделай рамку легче и прозрачнее. Рамка должна направлять взгляд на главный объект, а не отвлекать. "
