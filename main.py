...
async def do_generation(user_id: int, chat_id: int, gen_type: str):
    ...
    try:
        ...
        if "framing" in error_type:
            prompt += f" Улучши фрейминг: сохрани обрамление (ветки, арки, окна), но сделай его аккуратнее и выразительнее. Не убирай рамку полностью — обыграй её, чтобы она направляла взгляд на главный объект. {what_is_wrong} {how_to_fix}"
