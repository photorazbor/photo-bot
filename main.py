...
async def do_generation(user_id: int, chat_id: int, gen_type: str):
    ...
    try:
        ...
        prompt = (
            ...
            f"Убери с фона случайные отвлекающие объекты — провода, столбы, ветки, которые «торчат из головы» или отвлекают внимание. Если объект является частью композиции и создаёт атмосферу — сохрани его. "
