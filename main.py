...
async def do_generation(user_id: int, chat_id: int, gen_type: str):
    ...
    try:
        ...
        prompt = (
            ...
            f"Если есть фрейминг (ветки, арки, окна) — улучши его: сделай аккуратнее, выразительнее, убери только случайные ветки которые явно мешают. Но сохрани саму идею обрамления — рамка должна направлять взгляд на главный объект. "
