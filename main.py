...
FLAT_LAY_PROMPTS = {
    "cozy": "Создай атмосферный Flat Lay как из Pinterest. Полностью замени фон на тёплый деревянный стол с красивой текстурой. Добавь уютные детали: льняную салфетку, веточку, тёплый боковой свет. Распознай предметы и добавь УМЕСТНЫЙ декор. ЕСЛИ есть чашка — НАПОЛНИ её напитком. Сохрани все предметы с фото. Стиль — уютное кафе, тёплые тона.",
    
    "minimal": "Создай чистый минималистичный Flat Lay как из Pinterest. Полностью замени фон на белый. Идеальный порядок, много воздуха, геометричная композиция. Мягкий рассеянный свет. ЕСЛИ есть чашка — НАПОЛНИ её напитком. Сохрани все предметы с фото. Стиль — скандинавский минимализм.",
    
    "nature": "Создай природный Flat Lay как из Pinterest. Полностью замени фон на светлый мрамор с красивыми прожилками. Добавь ЖИВЫЕ зелёные листья, эвкалипт, цветы. Мягкий дневной свет. ЕСЛИ есть чашка — НАПОЛНИ её напитком. Сохрани все предметы с фото. НЕ добавляй сухую траву.",
    
    "dark": "Создай элегантный тёмный Flat Lay как из Pinterest. Полностью замени фон на чёрный матовый или тёмный мрамор. Драматичный боковой свет, глубокие тени. Добавь тёмные текстуры. ЕСЛИ есть чашка — НАПОЛНИ её напитком. Сохрани все предметы с фото. Стиль — дорогой и стильный.",
    
    "pastel": "Создай нежный пастельный Flat Lay как из Pinterest. Полностью замени фон на пастельный. Добавь живые цветы, воздушный свет. ЕСЛИ есть чашка — НАПОЛНИ её напитком. Сохрани все предметы с фото. Стиль — нежный и женственный.",
}
