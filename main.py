...
FLAT_LAY_PROMPTS = {
    "cozy": "Разложи предметы красиво на тёплом деревянном столе. Распознай, что на фото, и добавь УМЕСТНЫЙ декор, подходящий к этим предметам: для чая — чайные листья, печенье; для кофе — кофейные зёрна; для еды — приборы, салфетку. ЕСЛИ на фото есть чашка или кружка — НАПОЛНИ её чаем или кофе. Мягкий тёплый свет, уютная атмосфера. Сохрани все предметы с фото.",
    
    "minimal": "Разложи предметы минималистично на чистом белом фоне. Много пустого пространства, идеальный порядок. ЕСЛИ на фото есть чашка — НАПОЛНИ её напитком. Мягкий рассеянный свет. Сохрани все предметы с фото.",
    
    "nature": "Разложи предметы на красивом натуральном фоне: светлый камень или мрамор. Добавь ЗЕЛЁНЫЕ живые листья, веточки эвкалипта или цветы. ЕСЛИ на фото есть чашка — НАПОЛНИ её напитком. Мягкий дневной свет. НЕ добавляй сухую траву, мусор. Сохрани все предметы с фото.",
    
    "dark": "Разложи предметы на тёмном мраморном фоне. Драматичный свет, контраст. Добавь тёмные текстуры: камень, дерево. ЕСЛИ на фото есть чашка — НАПОЛНИ её напитком. Сохрани все предметы с фото.",
    
    "pastel": "Разложи предметы на нежном пастельном фоне. Добавь живые цветы, мягкий свет. ЕСЛИ на фото есть чашка — НАПОЛНИ её напитком. Сохрани все предметы с фото.",
}
