...
async def do_generation(user_id: int, chat_id: int, gen_type: str):
    ...
    try:
        ...
        # Базовый промпт с приоритетом горизонта
        prompt = (
            ...
            f"Если объекту тесно в кадре — уменьши его масштаб на 10-15% и добавь свободное пространство именно с той стороны, где не хватает воздуха. Дорисуй дополнительный фон. Не расширяй кадр там, где пространства достаточно. "
        ...
        # Точечные исправления на основе анализа
...
async def handle_admin(message: Message):
    ...
    if command == "stats":
        ...
        await message.answer("❌ Неизвестная команда. Используй /admin stats, users, history, gen, course, feedback")
