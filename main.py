...
async def do_generation(user_id: int, chat_id: int, gen_type: str):
    ...
    try:
        ...
        prompt = (
            ...
            f"Сохрани все важные детали и объекты. Размер: {img_size}."
        )
        ...
        if "pose" in error_type:
            prompt += f" Улучши позу человека: сделай её более изящной и естественной, но сохрани лицо без изменений. {what_is_wrong} {how_to_fix}"
