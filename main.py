...
FLAT_LAY_PROMPTS = {
    ...
    "nature": (
        ...
        "Фон — РАЗНООБРАЗНЫЙ натуральный: светлое дерево, бежевый лён, светлый камень, мрамор с прожилками, керамика. "
        "НЕ используй только белый мрамор — пробуй разные натуральные текстуры. "
        "РАСПОЗНАЙ, ЧТО ЗА ПРЕДМЕТЫ, и подбери уместный декор. "
        "ЕСЛИ это еда — красиво разложи её: аппетитно, ровно, не скомканно. "
        "Сушёные фрукты остаются сушёными, но выглядят эстетично. "
        "Можно добавить свежие фрукты, зелень, орехи рядом для контраста. "
        "Если это не еда — добавь зелёные листья, эвкалипт, цветы, камни. "
        "НЕ добавляй сухую траву. "
        "ЕСЛИ в кадре есть руки — сохрани их как на фото. "
        "НЕ дорисовывай кольца, часы, браслеты, если их не было на фото. "
        "РАССТАВЬ предметы гармонично — измени расположение. "
        "Мягкий дневной свет. "
        "Сохрани все предметы."
    ),
    "dark": (
