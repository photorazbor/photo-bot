...
async def handle_int_light(callback: CallbackQuery):
    ...
    gen_wish[user_id] = (
        ...
        "В кадре НЕ должно быть людей, ног, рук, силуэтов. "
        "Только интерьер без человека. "
        "Улучши освещение: сделай свет тёплым, мягким, как дневной. "
        "Убери тёмные углы, пересветы. "
        "НЕ меняй светильники, люстры, мебель, декор."
    )
    interior_active[user_id] = True
    gen_used_count[user_id] = 0
...
async def handle_int_decor(callback: CallbackQuery):
    ...
    gen_wish[user_id] = (
        ...
        "В кадре НЕ должно быть людей, ног, рук, силуэтов. "
        "Только интерьер без человека. "
        "Добавь уместный декор: подушки на диван, плед на кресло, "
        "вазу с цветами на стол, растение в углу, картину на стену. "
