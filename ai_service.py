...
- Заполнение кадра (тесно или пусто). Если рекомендуешь кадрирование — ОБЯЗАТЕЛЬНО добавляй crop_frame в drawings.
...
{
  "error_type": "horizon, thirds, leading_lines, framing, balance, shadow, fill_frame, distortion, pose, lighting, good_shot",
  ...
  "praise": "Что получилось ХОРОШО. ОБЯЗАТЕЛЬНО найди хотя бы одну реально удачную деталь: свет, цвет, момент, композиционный приём, эмоцию, хорошую позу. НЕ хвали за отсутствие тени — это не достижение. Напиши 1-2 предложения, которые мотивируют ученика продолжать снимать.",
  "drawings": [
