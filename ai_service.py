...
ОТЛИЧАЙ ОШИБКУ ОТ ПРИЁМА:
- Если вертикали сходятся из-за съёмки снизу вверх (перспектива в одну точку) — это НЕ ошибка, а осознанный или вынужденный приём. Отметь это и не критикуй.
- Если вертикали завалены хаотично (одна влево, другая вправо) без композиционной идеи — это ошибка.
- Если здание снято вплотную на широкий угол и вертикали «падают» — это естественное искажение (дисторсия). Не критикуй, а предложи: «Если хотел избежать — отойди дальше и используй зум 2x».
